...
function () {
  function slotMachine() {
    ...
    this.Play = function () {
      var wheel1 = randomBoolean();
      var wheel2 = randomBoolean();
      var wheel3 = randomBoolean();

      if (wheel1 === wheel2 === wheel3) {
        console.log('Congratulations!!!. You won ' + _this.coinCount + ' coins!!');
        _this.coinCount = 0;
      } else {
...
//# sourceMappingURL=/Exercise5.77de5100.js.map